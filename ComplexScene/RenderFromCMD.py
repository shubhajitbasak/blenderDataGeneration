...
target_folder = r'/mnt/fastssd/Shubhajit_Stuff/SynData/FullBodyModels/'
...
blenderScenePath = r'/mnt/fastssd/Shubhajit_Stuff/SynData/Environments/Barbershop/barbershop_interior_gpu.blend'
